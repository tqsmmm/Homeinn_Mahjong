    ...
    public partial class Details : Page
    {
        ...
        private void Load_Items()
        {
            ...
            for (int i = 0; i < Ds.Tables[0].Rows.Count; i++)
            {
                ...
                {
                    byte[] br = (byte[])(Ds.Tables[0].Rows[i][4]);
        ...
        private void LvItems_MouseLeftButtonUp(object sender, System.Windows.Input.MouseButtonEventArgs e)
        {
            if (lvItems.SelectedItems.Count > 0)
            {
                ...
                {
                    DB_Work.ExecuteCmd($"UPDATE Bills_Detail SET Num = Num + 1 WHERE id = {Ds.Tables[0].Rows[0][0]}");
                }
                else
                {
        ...
        private void Bt_Clean_Click(object sender, System.Windows.RoutedEventArgs e)
        {
            ...
            DB_Work.ExecuteCmd($"INSERT INTO Clean_Log(Rooms_Name, DateTime) VALUES('{tbRooms.Text}', GETDATE())");
