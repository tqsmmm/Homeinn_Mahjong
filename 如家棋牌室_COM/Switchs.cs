...
namespace 如家棋牌室_COM
{
    class Switchs
    {
        ...
        public static byte[] Return_Byte(int Device, int Num, bool Bit)
        {
            ...
            if (Device == 1)
            {
                switch (Num)
                {
                    ...
                    case 9:
                        if (Bit)
                            str = "01 05 05 0A FF 00 AC F4";
                        else
                            str = "01 05 05 0A 00 00 ED 04";
                        break;
                    case 10:
                        if (Bit)
                            str = "01 05 05 0B FF 00 FD 34";
                        else
                            str = "01 05 05 0B 00 00 BC C4";
                        break;
                    case 11:
                        if (Bit)
                            str = "01 05 05 0C FF 00 4C F5";
                        else
                            str = "01 05 05 0C 00 00 0D 05";
                        break;
                    case 12:
                        if (Bit)
                            str = "01 05 05 0D FF 00 1D 35";
                        else
                            str = "01 05 05 0D 00 00 5C C5";
                        break;
                    case 13:
                        if (Bit)
                            str = "01 05 05 0E FF 00 ED 35";
                        else
                            str = "01 05 05 0E 00 00 AC C5";
                        break;
                    case 14:
                        if (Bit)
                            str = "01 05 05 0F FF 00 BC F5";
                        else
                            str = "01 05 05 0F 00 00 FD 05";
                        break;
                }
            }
            else if (Device == 2)
            {
                switch (Num)
                {
                    ...
                    case 9:
                        if (Bit)
                            str = "02 05 05 0A FF 00 AC C7";
                        else
                            str = "02 05 05 0A 00 00 ED 37";
                        break;
                    case 10:
                        if (Bit)
                            str = "02 05 05 0B FF 00 FD 07";
                        else
                            str = "02 05 05 0B 00 00 BC F7";
                        break;
                    case 11:
                        if (Bit)
                            str = "02 05 05 0C FF 00 4C C6";
                        else
                            str = "02 05 05 0C 00 00 0D 36";
                        break;
                    case 12:
                        if (Bit)
                            str = "02 05 05 0D FF 00 1D 06";
                        else
                            str = "02 05 05 0D 00 00 5C F6";
                        break;
                    case 13:
                        if (Bit)
                            str = "02 05 05 0E FF 00 ED 06";
                        else
                            str = "02 05 05 0E 00 00 AC F6";
                        break;
                    case 14:
                        if (Bit)
                            str = "02 05 05 0F FF 00 BC C6";
                        else
                            str = "02 05 05 0F 00 00 FD 36";
                        break;
                }
            }
