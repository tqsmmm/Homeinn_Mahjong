...
namespace 如家棋牌室_COM
{
    class Prints
    {
        ...
        private static Bill Bills = new Bill();
        ...
        private static void Print_Settlement_Summary_PrintPage(object sender, PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawString("数量：" + Settlements.Num_Rooms, new Font("微软雅黑", 12), Brushes.Black, 150, intX);
            e.Graphics.DrawString("饮料：" + Settlements.Total_Drink, new Font("微软雅黑", 12), Brushes.Black, 0, intX + 22);
            e.Graphics.DrawString("香烟：" + Settlements.Total_Cigarette, new Font("微软雅黑", 12), Brushes.Black, 150, intX + 22);
            e.Graphics.DrawString("其他：" + Settlements.Total_Other, new Font("微软雅黑", 12), Brushes.Black, 0, intX + 44);
            e.Graphics.DrawString("总计：" + Settlements.Total, new Font("微软雅黑", 12), Brushes.Black, 150, intX + 44);

            e.Graphics.DrawLine(pen, new Point(0, intX + 66), new Point(300, intX + 66));

            e.Graphics.DrawString("结算：" + Settlements.Employees, new Font("微软雅黑", 12), Brushes.Black, 150, intX + 66);
